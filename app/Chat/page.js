...
export default function Page() {
  ...
  function searchChanged(e) {
    ...
    setSearchedUsersAndGroups([{label:"Furkan", value:1, type:"U"}, {label:"AileGrubu", value:2, type:"G"}]);
  }
  ...
  return (
    <Grid container height={"100vh"}>
      ...
      <Grid xl={10} border="solid" borderRadius={2}></Grid>
    </Grid>
  );
}